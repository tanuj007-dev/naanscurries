        ...
        <div className="mt-16 flex flex-col items-center justify-center gap-10 md:mt-24 md:flex-row md:items-center md:justify-between md:gap-4 lg:gap-12">
          ...
          */}
          ...
          <AnimateOnScroll variant="scale" delay={0.1} duration={0.8} className="relative w-full max-w-lg md:w-[500px] lg:w-[600px]">
            ...
            <div className="relative aspect-[4/3] w-full overflow-hidden rounded-lg border-4 border-[#FDF4E7] md:aspect-[16/10]">
              <Image
                src={imgSpices}
            ...
            <div className="absolute -left-2 -top-10 h-28 w-28 overflow-hidden rounded-lg border-4 border-[#FDF4E7] md:-left-12 md:-top-16 md:h-40 md:w-40 lg:h-48 lg:w-48">
              <Image
                src={imgCurrySpoon}
            ...
            <div className="absolute -bottom-10 -right-2 h-28 w-28 overflow-hidden rounded-lg border-4 border-[#FDF4E7] md:-bottom-16 md:-right-12 md:h-40 md:w-40 lg:h-48 lg:w-48">
              <Image
                src={imgCurryBowl}
