    ...
    <footer className="w-full bg-[#262626] px-6 py-12 md:px-10 md:py-16 lg:px-14 lg:py-20 text-[#e5e5e5]">
      <div className="mx-auto max-w-7xl">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-3 lg:grid-cols-[1.5fr_1fr_1fr]">
          ...
          {/* â”€â”€ Left Column: Logo & Socials â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
          <div className="flex flex-col justify-between h-full">
            ...
            <div className="hidden mt-16 text-xs text-[#e5e5e5]/60 md:block" style={{ fontFamily: "var(--font-futura)" }}>
              Â© Naans & Curries 2026. {t("rights")}.
            </div>
          </div>

          {/* â”€â”€ Middle Column: Navigation â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
          ...
          {/* â”€â”€ Right Column: Contact & WhatsApp Badge â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
            ...
            <div className="relative mt-12 md:mt-0">
              <div className="relative flex h-32 w-32 items-center justify-center">
                ...
                <div className="absolute inset-0 animate-spin-slow">
                  <svg viewBox="0 0 100 100" className="h-full w-full overflow-visible" textRendering="optimizeLegibility">
                    <defs>
                      <path id="circlePath" d="M 50, 50 m -42, 0 a 42,42 0 1,1 84,0 a 42,42 0 1,1 -84,0" />
                    </defs>
                    <text className="fill-[#e5e5e5] text-[7px] font-medium uppercase tracking-[0.4em]" style={{ fontFamily: "var(--font-futura)" }}>
                      <textPath href="#circlePath" startOffset="0%" dominantBaseline="middle">
                        Call us for booking a table quickly â€¢ Call us for booking a table quickly â€¢
                      </textPath>
                    </text>
                  </svg>
                </div>
